...
class GalleryIndexer extends AbstractIndexer implements SearchResultFormatterInterface
{
    private const TABLE_NAME = 'tx_maigallery_gallery';
    ...
    protected function buildContent(object $record): string
    {
        ...
        return strip_tags($record->getDescription());
    }
    ...
    protected function getRecordsForIndexing(IndexingContext $context): iterable
    {
        ...
        return $dataMapper->map(Gallery::class, $rows);
    }
